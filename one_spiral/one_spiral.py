...
class SpiderController(Sofa.Core.Controller):
	...
	def onAnimateBeginEvent(self,event):
          ...
          ###########################  spiral length #########################
            ...
            spiral_length = self.pos_spiral[6][1] - self.pos_spiral[23][1]
    ...
    ###########################  spiral spiral_segment #########################
            ...
            spiral_segment_1 = self.pos_spiral[275][1] - self.pos_spiral[23][1]
            self.file_spiral = open(path + 'position_spiral.txt', 'w') 
            #print(spiral_length, file= self.file_spiral)
            #print("spiral_segment_1 is :",spiral_segment_1 )   
            epislon_1= (spiral_segment_1 -  4.434185028075021)/  4.434185028075021
            print("epislon_1 :", epislon_1)
            
            
            
                        
            spiral_segment_2 = self.pos_spiral[149][1] - self.pos_spiral[17][1]
            self.file_spiral = open(path + 'position_spiral.txt', 'w') 
            #print(spiral_length, file= self.file_spiral)
            #print("spiral_segment_2 is :",spiral_segment_2 )
            epislon_2= (spiral_segment_2 -   4.399686813351494)/   4.399686813351494
            print("epislon_2 :", epislon_2)
            
                        
            spiral_segment_3 = self.pos_spiral[126][1] - self.pos_spiral[149][1]
            self.file_spiral = open(path + 'position_spiral.txt', 'w') 
            #print(spiral_length, file= self.file_spiral)
            #print("spiral_segment_3 is :",spiral_segment_3 )
            epislon_3= (spiral_segment_3 - 4.423772811886522  )/  4.423772811886522
            print("epislon_3 :", epislon_3)
            
            

            spiral_segment_4 = self.pos_spiral[139][1] - self.pos_spiral[177][1]
            self.file_spiral = open(path + 'position_spiral.txt', 'w') 
            #print(spiral_length, file= self.file_spiral)
            #print("spiral_segment_4 is :",spiral_segment_4 )
            epislon_4= (spiral_segment_4 - 4.491426467895096 )/ 4.491426467895096 
            print("epislon_4 :", epislon_4)
            
            
            
            spiral_segment_5 = self.pos_spiral[6][1] - self.pos_spiral[115][1]
            self.file_spiral = open(path + 'position_spiral.txt', 'w') 
            #print(spiral_length, file= self.file_spiral)
            #print("spiral_segment_5 is :",spiral_segment_5 )
            epislon_5= (spiral_segment_5 - 4.465587615969994 )/ 4.465587615969994
...
def createScene(rootNode):
  ...
  ##########################################
   ...
   #matrix.addObject('PositionConstraint', indices= "725 806 974 599 627 911 1125 505 519 832 1003 520 541 662 1039 466 581 644 734 892 951 960 1232 1449 1458 1462 224 296 462 541 154 156 393 540",valueType="displacement", value=50, useDirections=[0, 1, 0]) 
    ...
    spiral.addObject('MeshVTKLoader', name='loader', filename=path + 'one_spiral_0.vtk', rotation=[0, 0, 0])
    ...
    spiralVisu.addObject('MeshSTLLoader', filename=path + "one_spiral_0.stl", name="loader")
