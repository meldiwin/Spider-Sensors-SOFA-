   ...
   #***********************  hex5  ************************#
    ...
    #***********************  hex5  ************************#
       ...
       ######************ Kirchoff equations ****########
            ...
            ### nodes first stage 
            A[0][0]= 1;   A[0][8]= -1;     A[0][6] = -1;
            A[1][1]= 1;   A[1][18]= -1;	   A[1][8] = 1;	    A[1][9] = -1;
            A[2][2]= 1;   A[2][10]= -1;	   A[2][9] = 1;
            A[3][3]= 1;   A[3][10]= 1;	   A[3][11] = -1;	A[3][17] = -1;
            A[4][4]= 1;   A[4][12]= -1;	   A[4][3] = 1;	
            A[5][5]= 1;   A[5][12]= 1;	   A[5][13] = -1;	A[5][19] = -1;
            A[6][6]= 1;   A[6][14]= -1;	   A[6][13] = 1;	
            A[7][7]= 1;   A[7][15]= -1;	   A[7][16] = -1;	A[7][14] = 1;
            
            
            #### loop first stage  ############ check 
            A[8][8]=r9 ;    A[8][18]=r19;   A[8][16] = -r17; A[8][15] = -r16;
            A[9][9]=r10 ;    A[9][10]=r11;   A[9][18] = -r19; A[9][17] = -r18;
            A[12][12]=r13 ;    A[12][11]=r12;   A[12][19] = -r20; A[12][17] = -r18;
            A[13][13]=r14 ;    A[13][14]=r15;   A[13][16] = -r17; A[13][19] = -r20;
          
                      
########### Boundary Conditions 8 and 4 main radial ############## 
...
#####  I[7] is I_6 ########
            ...
            V = r16 * I[15] + r9 * I[8] + r10 * I[9] +  r11 * I[10]         
            R_t84 = V;
            print(R_t84)
            
            ########### Boundary Conditions 2 and 6 main radial ############## 
            ...
            V = r9 * I[8] + r16 * I[15] + r15 * I[14] +  r14 * I[13]         
            R_t26 = V;
            print(R_t26)
