...
#*********************** Radials    ************************#
    ...
    ################################# Spirals ##############################################
            ...
            epsilon_13 = ((thirteen - 2.934501647948508 )/ 2.934501647948508)*100
    
            r13 = R_spiral_1/2711.890962292 *( 40.9786262984012 * epsilon_13 + 2711.890962292)
            
    
            ########### fourteen #####################
            fourteen = self.pos_three_stage[184][1] - self.pos_three_stage[170][1]
           
            epsilon_14 = ((fourteen - 1.7959976196279968)/ 1.7959976196279968)*100            
            ...
            epsilon_15 = ((fiveteen - 0.8990020751959662 )/ 0.8990020751959662)*100
            ...
            epsilon_16 = ((sixteen - 2.9815025329589915 )/2.9815025329589915)*100
            ...
            #print("seventeen is :", seventeen_1)
                 
            epsilon_17 = ((seventeen -2.040498733519996 )/ 2.040498733519996)*100
            ...
            epsilon_18 = ((eighteen - 0.9567489624021803 )/ 0.9567489624021803)*100
            ...
            epsilon_19 = (( nineteen  - 2.500249862675105)/ 2.500249862675105)*100
            ...
            epsilon_20 = (( twenty  - 1.7639999389652132)/1.7639999389652132)*100
            ...
            epsilon_21 = (( twentyone   - 0.945003509525975)/ 0.945003509525975)*100
            ...
            epsilon_22 = (( twentytwo   - 2.981502532958295)/ 2.981502532958295)*100
            ...
            epsilon_23 = (( twentythree   - 1.9342489242550158)/1.9342489242550158)*100
            ...
            epsilon_24 = (( twentyfour   - 0.9850006103519959)/ 0.9850006103519959)*100
            ...
            epsilon_25 = (( twentyfive  - 2.8257503509586854)/ 2.8257503509586854)*100
            ...
            epsilon_26 = ((  twentysix  - 2.0360031128000315)/ 2.0360031128000315)*100
            r26_ = R_spiral_2/2711.890962292 *( 40.9786262984012 * epsilon_26 + 2711.890962292 )
            
            ########### twentyseven ################### 
            twentyseven = self.pos_three_stage[309][1] - self.pos_three_stage[315][1]
            #print("twentyseven_1  is :", twentyseven_1 )
        
            epsilon_27 = (( twentyseven - 2.0304985046348776)/ 2.0304985046348776)*100
            r27 = R_spiral_3 /2711.890962292 *( 40.9786262984012 * epsilon_27 + 2711.890962292 )
            
           
            ########### twentyeight ################### 
            
            twentyeight = self.pos_three_stage[37][1] - self.pos_three_stage[25][1]
            #print("twentyeight_1 is :", twentyeight_1)
            
            epsilon_28 = ((twentyeight - 2.934501647948494)/2.934501647948494)*100
            r28 = R_spiral_1 /2711.890962292 *( 40.9786262984012 * epsilon_28 + 2711.890962292 )
            
        
            ######### twentynine ###########
            twentynine = self.pos_three_stage[101][1] - self.pos_three_stage[89][1]
            #print("twentynine_1 is :", twentynine_1)
            
            epsilon_29 = ((twentynine - 2.0315017700190197)/ 2.0315017700190197)*100
            r29 = R_spiral_2 /2711.890962292 *( 40.9786262984012 * epsilon_29 + 2711.890962292 )
        
            ######### thirty ###########
           
            thirty = self.pos_three_stage[289][1] - self.pos_three_stage[303][1]
            #print(" thirty_1 is :",  thirty_1)
            
            epsilon_30 = ((thirty - 0.8990020751960088)/0.8990020751960088)*100
            ...
            ######### thirtyone ###########
            thirtyone = self.pos_three_stage[2225][1] - self.pos_three_stage[2184][1]
