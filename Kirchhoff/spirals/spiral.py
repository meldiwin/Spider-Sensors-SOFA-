...
#***********************  spiral (7)  ************************#
            ...
            spiral_7 = self.pos_spiral[305][1] - self.pos_spiral[280][1] 
            #print("spiral_1 is :", spiral_1)
            
            epsilon_7 = 100*((spiral_7 - 14.260002136222013)/ 14.260002136222013)
...
#***********************   spiral (8) ************************#
            ...
            spiral_8 = self.pos_spiral[175][1] - self.pos_spiral[303][1] 
            #print("spiral_2 is :", spiral_2)
            
            epsilon_8 = 100*((spiral_8 - 14.351997375489987)/14.351997375489987)
...
#***********************   spiral (9)  ************************#
            ...
            spiral_9 = self.pos_spiral[97][0] - self.pos_spiral[47][0] 
            #print("spiral_3 is :", spiral_3)
            
            epsilon_9 = 100*((spiral_9 - 14.506996154785)/14.506996154785)
...
#***********************  spiral (10)  ************************#
            ...
            spiral_10 = self.pos_spiral[93][1] - self.pos_spiral[41][1]
            #print("spiral_4  is :", spiral_4 )
            
            epsilon_10 = 100*((spiral_10 - 14.338005065909996 )/14.338005065909996)
...
#***********************   spiral (11)  ************************#
            ...
            spiral_11 = self.pos_spiral[40][1] - self.pos_spiral[220][1]
            #print("spiral_5 is :", spiral_5)
            
            epsilon_11 = 100*((spiral_11 - 14.285003662106988 )/14.285003662106988)
...
#***********************   spiral (12)  ************************#
            ...
            spiral_12 = self.pos_spiral[219][0] - self.pos_spiral[252][0]
            #print("spiral_6 is :", spiral_6)

            epsilon_12 = ((spiral_12 - 14.461002349853004)/14.461002349853004)*100
