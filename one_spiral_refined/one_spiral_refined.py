...
class SpiderController(Sofa.Core.Controller):
	...
	def onAnimateBeginEvent(self,event):
          ...
          ###########################  spiral length #########################
            ...
            spiral_length = self.pos_spiral[37][1] - self.pos_spiral[0][1]
    ...
    ############################  spiral spiral_segment #########################
            ...
            spiral_segment_1 = self.pos_spiral[319][1] - self.pos_spiral[0][1]
            #self.file_spiral = open(path + 'position_spiral.txt', 'w') 
            #print(spiral_length, file= self.file_spiral)
            #print("spiral_segment_1 is :",spiral_segment_1 )   
            epislon_1= (spiral_segment_1 - 3.8088150024398004  )/3.8088150024398004  
            print("epislon_1 :", epislon_1)
            
            
            
                        
            spiral_segment_2 = self.pos_spiral[470][1] - self.pos_spiral[319][1]
            #self.file_spiral = open(path + 'position_spiral.txt', 'w') 
            ##print(spiral_length, file= self.file_spiral)
            #print("spiral_segment_2 is :",spiral_segment_2 )
            epislon_2= (spiral_segment_2 -  3.9320499940575075)/ 3.9320499940575075
            print("epislon_2 :", epislon_2)
            
                        
            spiral_segment_3 = self.pos_spiral[598][1] - self.pos_spiral[470][1]
            #self.file_spiral = open(path + 'position_spiral.txt', 'w') 
            ##print(spiral_length, file= self.file_spiral)
            #print("spiral_segment_3 is :",spiral_segment_3 )
            epislon_3= (spiral_segment_3 - 3.816502577090901 )/  3.816502577090901
            print("epislon_3 :", epislon_3)
            
            

            spiral_segment_4 = self.pos_spiral[139][1] - self.pos_spiral[598][1]
            #self.file_spiral = open(path + 'position_spiral.txt', 'w') 
            ##print(spiral_length, file= self.file_spiral)
            #print("spiral_segment_4 is :",spiral_segment_4 )
            epislon_4= (spiral_segment_4 - 3.926934947166913 )/ 3.926934947166913
            print("epislon_4 :", epislon_4)
            
            
            
            spiral_segment_5 = self.pos_spiral[37][1] - self.pos_spiral[113][1]
            #self.file_spiral = open(path + 'position_spiral.txt', 'w') 
            ##print(spiral_length, file= self.file_spiral)
            #print("spiral_segment_5 is :",spiral_segment_5 )
            epislon_5= (spiral_segment_5 - 3.8399200439498884 )/ 3.8399200439498884
...
def createScene(rootNode):
  ...
  ##########################################
   ...
   #matrix.addObject('PositionConstraint', indices= "725 806 974 599 627 911 1125 505 519 832 1003 520 541 662 1039 466 581 644 734 892 951 960 1232 1449 1458 1462 224 296 462 541 154 156 393 540",valueType="displacement", value=50, useDirections=[0, 1, 0]) 
    ...
    spiral.addObject('MeshVTKLoader', name='loader', filename=path + 'one_spiral_refined.vtk', rotation=[0, 0, 0])
    ...
    spiralVisu.addObject('MeshSTLLoader', filename=path + "one_spiral_refined.stl", name="loader")
